...
const ManageUserPage = () => {
  ...
  const handleDeleteUser = async (id: string) => {
    ...
    if (res.id) {
      ...
      router.push("/super-admin/manage-user");
  ...
  const userData = data?.map((user: any) => ({
    ...
    actionButton: (
      <div className="flex lg:flex-row flex-col">
        <Modal
          htmlFor={`super-admin/manage-user/view/${user?.id}`}
          label="View"
          btnSize="btn-xs"
        ...
        {loggedInUser.role !== "super_admin" && user?.role === "client" && (
          <button
            ...
            onClick={() =>
              router.push(`/super-admin/manage-user/update/${user?.id}`)
            }
          >
            update
          </button>
        ...
        {loggedInUser.role === "super_admin" &&
          user?.role !== "super_admin" && (
            <Modal
              htmlFor={`super-admin/manage-user/promote/${user?.id}`}
              label="Role Update"
              btnSize="btn-xs"
  ...
  return (
    <div>
      <ActionHeader
        label="Users"
        href="/super-admin/manage-user/create"
        doSearch={false}
      />
