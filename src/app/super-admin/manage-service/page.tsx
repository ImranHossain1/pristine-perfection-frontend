...
const ManageServicePage = () => {
  ...
  const serviceData = data.map((service: any) => ({
    ...
    actionButton: (
      <div className="flex lg:flex-row flex-col">
        <Modal
          htmlFor={`super-admin/manage-service/view/${service?.id}`}
          label="View"
          btnSize="btn-xs"
        ...
        <button
          ...
          onClick={() =>
            router.push(`/super-admin/manage-service/update/${service?.id}`)
          }
        >
          update
        </button>
        <Modal
          htmlFor={`super-admin/service/delete/${service?.id}`}
          label="Delete"
          btnSize="btn-xs"
          btnTheme="btn-error"
          modalOpen={modalOpen}
  ...
  return (
    <div>
      <ActionHeader
        label="Services"
        href="/super-admin/manage-service/create"
